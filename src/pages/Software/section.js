                        ...
                        <Row className="align-items-center position-relative mt-2" style={{zIndex: "1"}}>
                            <Col lg="6" md="12">
                                <div className="title-heading mt-4 text-center text-lg-left">
                                    ...
                                    <p className="lead para-desc text-muted">The commerce as service management platform delivering innovative payment solutions for start-ups and enterprise businesses alike.</p>
                                    <div className="mt-4">
