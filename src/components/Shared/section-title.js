                    ...
                    <Row className={this.props.isLeft ? "" : "justify-content-center"}>
                        <Col xs="12" className={this.props.isLeft ? "" : "text-center" }>
                            <div className="section-title mb-4 pb-2" name="maintitle">
                                ...
                                <p className={this.props.isLeft ? "text-muted para-desc mb-0" : "text-muted para-desc mx-auto mb-0"} name="sectiondesc"><span className="text-dark font-weight-bold">Elektropay</span> {this.props.desc} </p>
                            </div>
                        </Col>
                    </Row>
            </React.Fragment>
