      ...
      <React.Fragment>
        ...
        <footer className="footer footer-bar">
          ...
          <li className="list-inline-item mr-0"><img src={pci} alt="" /></li>
                    ...
                    <Col md="4" sm="6" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <ul className="list-unstyled list-inline-item copyright-menu text-muted mb-0 small">
                              {
                                this.state.grid5.map((grid, key) =>
                     <li key={key}><Link to={grid.link} className={this.props.isLight ? "text-muted small" : "text-copyright"}>{grid.title} </Link></li>
                                )
                            }
                        </ul>
                      </Col>
